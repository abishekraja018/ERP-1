...
urlpatterns = [
    ...
    path("announcements/announcements/", views.announcements, name="announcements"),
    ...
    path("course-allocation/edit/<int:allocation_id>/", hod_views.edit_course_allocation, name='edit_course_allocation'),
    path("course-allocation/delete/<int:allocation_id>/", hod_views.delete_course_allocation, name='delete_course_allocation'),
    path("course-allocation/assign-students/<int:allocation_id>/", hod_views.assign_students_to_allocation, name='assign_students_allocation'),
